...
*/
// const copyofArtists = artists.slice();
...
addArtist(artists,'Seraphim Freese', '1998 - 2023', 'Web Design', 'Taiwanese and caucasion', 'Moved to the U.S. at the age of 9. Began taking guitar lessons at the age of 11 and had already been taking piano lessons from the age of 4. She has written many pieces on the piano and loves using music for therapy')
...
const numberofPaintings = [];
for(let i = 0; i < array.length; i++) {
if(array[i].paintings > 100) {  
numberofPaintings.push(array[i].name)
}
...
// const result = array.filter(result => {if (result.paintings >= 100) return array.name})
// return result
...
//pseudo-code
//receiving the artists array
//create an empty array
//create a for loop to iterate thru the artists array to look for names
//return the bio whos name is called
...
//   const countryArray = array.slice();
//   for(let i = 0; i < countryArray.length; i++){
//     return countryArray.nationality
//   }
const countryArray = [];
for (let i = 0; i < array.length; i++){
...
//pseudo-code
//create an empty array
//need a loop to iterate over the array
//and need an if statement inside the loop
//the if statement need to be STRICTLY(===) looking for a single specific nationality
//return only the name ONLY from said nationality
